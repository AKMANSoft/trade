...
import { Button, Row, Col, Dropdown, Space, Select, Form, Radio, Avatar, Tag, Timeline, Menu, Tabs, Steps, Modal } from "antd";
...
const Track = ()=> {
  ...
  const trackingDetail = () => {
    navigate('/tracking/track-detail')
  }
          ...
          <Row type='flex' justify='space-between' align='middle' gutter={20}>
            ...
            <Col span={24}>
              <Space size={8} className='w-100 scroll-x'>
                <Button type='gradient-primary'>All</Button>
                <Button type='gray'>In Negotiation</Button>
                <Button type='gray'>Offer Accepted</Button>
                <Button type='gray'>Payment</Button>
                <Button type='gray'>In Process</Button>
                <Button type='gray'>Empty returned</Button>
              </Space>
            </Col>
          </Row>

          <div className='tacking-rows'>
            {[...Array(3)].map((x, i) =>
              <div className='container-box p-0 available-container-box' onClick={trackingDetail}>
                      ...
                      <Row type='flex' justify='space-between' align='middle' gutter={20}>
                        <Col>
                          <Space size={0}>
                            ...
                            <Tag bordered={false}>Match Found (1)</Tag>
                          </Space>
                        </Col>
                      </Row>
                    </div>
                        ...
                        items={[
                          ...
                          },
                          {
                            ...
                            icon: (
                              <>
                                <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M8.25 7.76475L0.8295 9.78825C0.591329 9.85335 0.381142 9.99489 0.23127 10.1911C0.0813972 10.3873 0.000140968 10.6273 0 10.8742L0 26.6243C0 27.1313 0.3405 27.5768 0.8295 27.7103L8.25 29.7337V7.76475ZM34.974 9.75375L10.5 7.59375V29.9048L34.974 27.7448C35.2541 27.72 35.5148 27.5912 35.7047 27.3839C35.8946 27.1765 36 26.9055 36 26.6243V10.8742C36 10.593 35.8946 10.322 35.7047 10.1146C35.5148 9.90725 35.2541 9.7785 34.974 9.75375ZM15.75 24.3743C15.75 24.6726 15.6315 24.9588 15.4205 25.1697C15.2095 25.3807 14.9234 25.4993 14.625 25.4993C14.3266 25.4993 14.0405 25.3807 13.8295 25.1697C13.6185 24.9588 13.5 24.6726 13.5 24.3743V13.1242C13.5 12.8259 13.6185 12.5397 13.8295 12.3288C14.0405 12.1178 14.3266 11.9992 14.625 11.9992C14.9234 11.9992 15.2095 12.1178 15.4205 12.3288C15.6315 12.5397 15.75 12.8259 15.75 13.1242V24.3743ZM21.75 23.6243C21.75 23.9226 21.6315 24.2088 21.4205 24.4197C21.2095 24.6307 20.9234 24.7493 20.625 24.7493C20.3266 24.7493 20.0405 24.6307 19.8295 24.4197C19.6185 24.2088 19.5 23.9226 19.5 23.6243V13.8742C19.5 13.5759 19.6185 13.2897 19.8295 13.0788C20.0405 12.8678 20.3266 12.7492 20.625 12.7492C20.9234 12.7492 21.2095 12.8678 21.4205 13.0788C21.6315 13.2897 21.75 13.5759 21.75 13.8742V23.6243ZM27.75 22.8743C27.75 23.1726 27.6315 23.4588 27.4205 23.6697C27.2095 23.8807 26.9234 23.9993 26.625 23.9993C26.3266 23.9993 26.0405 23.8807 25.8295 23.6697C25.6185 23.4588 25.5 23.1726 25.5 22.8743V14.6242C25.5 14.3259 25.6185 14.0397 25.8295 13.8288C26.0405 13.6178 26.3266 13.4992 26.625 13.4992C26.9234 13.4992 27.2095 13.6178 27.4205 13.8288C27.6315 14.0397 27.75 14.3259 27.75 14.6242V22.8743ZM33 22.4993C33 22.7976 32.8815 23.0838 32.6705 23.2947C32.4595 23.5057 32.1734 23.6243 31.875 23.6243C31.5766 23.6243 31.2905 23.5057 31.0795 23.2947C30.8685 23.0838 30.75 22.7976 30.75 22.4993V15.3742C30.75 15.0759 30.8685 14.7897 31.0795 14.5788C31.2905 14.3678 31.5766 14.2492 31.875 14.2492C32.1734 14.2492 32.4595 14.3678 32.6705 14.5788C32.8815 14.7897 33 15.0759 33 15.3742V22.4993Z" fill="#9D9D9D"/>
                                </svg>
                              </>
                            ),
                          },
